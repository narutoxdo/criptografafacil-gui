...
#programa com iterface grafica de criptografia facil de arquivos
#o codigo é livre para ser modificado, o programa em si é um projeto livre
#Não usar de modo malicioso  
